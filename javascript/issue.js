...
async function main() {
	...
	issue(rollNo,subjectCode,studentUniqueID, grade, hash);
}


async function issue(rollNo,subjectCode,studentUniqueID, grade, hash)
{
    ...
    try {
        ...
        await contract.submitTransaction('issue', rollNo, subjectCode, studentUniqueID, grade, hash);
